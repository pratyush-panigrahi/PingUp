...
return (
    ...
    <div className='flex flex-col md:flex-row items-start gap-6'>
        ...
        {/* Profile Picture */}
        <div className='w-32 h-32 border-4 border-white shadow-lg rounded-full absolute -top-16'>
        <img
        ...
        <div className='flex flex-col md:flex-row items-start justify-between'>
            ...
            { /* if user is opening his own profile so we will give edit button */}
            {!profileId && <button onClick = {()=> setShowEdit(true)}className='flex items-center gap-2
        ...
        <div className='flex items-center gap-6 mt-6 border-t border-gray-200 pt-4'>
            <div>
                ...
                <span className='text-x5 sm:text-sm text-gray-500 ml-1.5'>Posts</span>
            </div>
            <div>
                <span className='sm:text-xl font-bold text-gray-900'>{user.followers.length}</span>
                <span className='text-x5 sm:text-sm text-gray-500 ml-1.5'>Followers</span>
            </div>
            <div>
                <span className='sm:text-xl font-bold text-gray-900'>{user.following.length}</span>
                <span className='text-x5 sm:text-sm text-gray-500 ml-1.5'>Following</span>
            </div>
        </div>
        </div>
