...
<div className="bg-white rounded-lg shadow p-6">
        ...
        <div className='flex flex-col items-start gap-3'>
            ...
            <div className='group/profile relative'>
                <img src={editForm.profile_picture ? URL.createObjectURL
                    ...
                    <div className='absolute hidden group-hover/profile:flex top-0 left-0 right-0
        ...
        <label
            ...
            <div className='group/cover relative'>
                <img src={editForm.cover_photo ? URL.createObjectURL
                    ...
                    alt="" className='w-80 h-40 rounded-lg bg-gradient-to-r
        ...
        <div>
            ...
            <textarea rows={3} className='w-full p-3 border border-gray-200 rounded-lg'
                placeholder='Enter your bio' onChange={(e)=>
        ...
        <div>
            ...
            <input type="text" className='w-full p-3 border border-gray-200 rounded-lg'
                placeholder='Please enter your location' onChange={(e)=>
                    ...
                    className='px-4 py-2 border border-gray-300 rounded-1g text-gray-700
                    ...
                    transition cursor-pointer'>Save Changes</button>
                    </div>
